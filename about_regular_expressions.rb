...
class AboutRegularExpressions < Neo::Koan
  ...
  # Repetition operators that match more than is specified in the
  # regular expression are said to be "greedy" because they match
  # their target until the pattern fails
  def test_plus_means_one_or_more
    assert_equal "bccc", "abbcccddddeeeee"[/bc+/]
  end
  # Asterisk fails to match without a target (preceeding letter)
  ...
  # ------------------------------------------------------------------
  # A character class sepecifies a set of characters, whereas an
  # alternation (|) specifies a set of strings to be matched
