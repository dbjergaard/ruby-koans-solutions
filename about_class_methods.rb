...
class AboutClassMethods < Neo::Koan
  ...
  # Prefer class << self contruct when defining many methods at once
  # to avoid self.method being repeated over and over. Likewise,
  # prefer self.method construct when only adding a method to a class.
